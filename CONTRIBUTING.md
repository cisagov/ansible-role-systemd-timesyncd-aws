...
issue](https://github.com/cisagov/ansible-role-systemd-timesyncd-aws/issues) in
...
request](https://github.com/cisagov/ansible-role-systemd-timesyncd-aws/pulls), you
...
```console
cd ansible-role-systemd-timesyncd-aws
pyenv virtualenv <python_version_to_use> ansible-role-systemd-timesyncd-aws
pyenv local ansible-role-systemd-timesyncd-aws
